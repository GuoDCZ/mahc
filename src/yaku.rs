...
impl Yaku {
    pub fn to_string(&self, is_open: bool) -> String {
        match self {
            ...
            Yaku::KokushiMusou13SidedWait => "KokushiMusou 13 sided wait".to_string(),
            ...
            Yaku::SuuankouTankiWait => "Suuankou Tanki Wait ".to_string(),
            Yaku::Daichiishin => "Daichiishin ".to_string(),
            Yaku::ChuurenPoutou9SidedWait => "ChuurenPoutou 9 sided wait ".to_string(),
        }
    }
    ...
    pub fn get_han(&self, is_open: bool) -> u16 {
        match self {
            ...
            Yaku::KazoeYakuman => 1,
            Yaku::KokushiMusou => 1,
            Yaku::KokushiMusou13SidedWait => 2,
            Yaku::Suuankou => 1,
            Yaku::Daisangen => 1,
            Yaku::Shousuushii => 1,
            Yaku::Daisuushii => 2,
            ...
            Yaku::ChuurenPoutou9SidedWait => 2,
            Yaku::Suukantsu => 1,
            Yaku::Tenhou => 1,
            Yaku::Chiihou => 1,
            Yaku::SuuankouTankiWait => 2,
            Yaku::Daichiishin => 1,
        }
    }
